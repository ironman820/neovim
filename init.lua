...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>bh', '<CMD>blast<CR>', { desc = 'Last Buffer' })
...
vim.keymap.set('n', '-', '<CMD>Oil<CR>', { desc = 'Open Oil folder manager' })
